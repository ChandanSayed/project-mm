...
const Chat7 = ({ showMenu, handleChatInput, inputField }) => {
              ...
              <div className="pb-8 px-3 lg:px-4">
                ...
                <div className="bg-blue bg-opacity-5 px-4 py-5 rounded-b-xl border-t-[3px] border-t-blue grid grid-cols-1 lg:grid-cols-5">
                  <div className="col-span-1 md:col-span-1 flex items-center">
                    ...
                    <p className="text-blue text-[13px] leading-normal mt-[1.7px] lg:text-sm font-jetBrain pl-[10px]">[MessageMoment]</p>
                  </div>
