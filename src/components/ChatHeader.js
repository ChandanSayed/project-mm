...
const ChatHeader = () => {
  ...
  return (
    <>
      <header className={`lg:bg-white border-t-[5px] border-t-blue ${mobileChatNav ? 'bg-blue border-b border-b-white h-screen fixed z-50 w-full' : 'bg-white'}`}>
        <nav className={`flex items-center w-full max-w-[1440px] mx-auto px-5 py-4 ${mobileChatNav ? 'pb-[19px] border-b border-b-white border-opacity-10' : ''}`}>
          {/* <SiteLogo width="w-[150px]" /> */}
          <Image src={LogoMini} alt="Mini Logo" />
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none text-white">
                    ...
                    <Menu.Item>
                      <div className="bg-black  py-[6px] px-[24px] flex items-center  border-b border-dark border-opacity-50">
                    ...
                    <Menu.Item>
                      <div className="bg-black py-[6px] px-[24px] pb-[22px] rounded-b-xl border-dark ">
                        <p className="bg-white mt-[10px] rounded-lg bg-opacity-10 text-[9px] font-jetBrain px-5 py-[17px]">{link}</p>
                        <div className="flex items-center cursor-pointer mt-[5px] " onClick={onCopy}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                          ...
                          <p className="ml-3 text-[13px] font-semibold leading-[23px]  text-white font-jetBrain">Copy URL</p>
                        </div>
                      </div>
                    </Menu.Item>
                  </Menu.Items>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center bg-white bg-opacity-90">
                      ...
                      <div className="flex justify-center flex-col items-center">
                        ...
                        <div className=" relative bg-white border border-black border-opacity-10 flex justify-center flex-col items-center max-w-[720px] z-20 rounded-[10px] w-full px-7">
                          ...
                          <div className=" pb-[60px]">
                            <h1 className="text-blue mx-[29px] lg:mx-[125px] lg:text-[26px] font-bold leading-none text-[20px] mb-5 lg:mb-0 tracking-[-1px] lg:tracking-[-2px] pt-20 ">Are you sure that you want to leave this chat conversation?</h1>
                            <h3 className="text-blue text-[17px] lg:text-[26px] text-center max-w-[324px] lg:max-w-[470px]"></h3>
                            <p className="font-jetBrain text-[16px] lg:mx-[50px] mx-[29px] font-normal lg:text-[16px] text-center -mb-[9px] mt-[21px] lg:mt-[30px]">Once all users have disconnected from this chat session, it will no longer be accessible by anyone using this link.</p>
                            ...
                            <div className="flex justify-center items-center">
                              <button type="button" className="font-jetBrain rounded-md h-[46px] w-[150px] px-5 border mr-[10px] font-semibold ml-[15px] !text-[16px] " onClick={closeModal}>
                                Cancel
                              </button>
                              <button type="button" className="font-jetBrain rounded-md bg-blue h-[46px] w-[150px] px-5 border mr-[10px] font-semibold ml-[15px] !text-[14px] text-white" onClick={closeModal}>
                                Leave
                              </button>
                            </div>
                          </div>
