...
const BlurSection = ({ img, padding, pt = '', largeHeader = false, returnHome = true, heading, description, sessionLink = false }) => {
  return (
    <div className={`px-[15px] ${padding}`}>
      <div className="flex justify-center flex-col items-center">
        ...
        <div className=" relative bg-white border border-black border-opacity-10 flex justify-center flex-col items-center max-w-[720px] z-20 rounded-[10px] w-full px-7">
          <Image src={img} className="w-[100px] -top-[50px] lg:w-[128px] absolute lg:-top-[62px]" alt="image" />
