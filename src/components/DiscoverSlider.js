...
const DiscoverSlider = () => {
  ...
  function handleSlidePrev() {
    if (carousel.current.scrollLeft < 200) {
      setHideFirst(false);
    }
  ...
  function handleSlideNext(e) {
    ...
    carousel.current.scrollLeft += 190;
    if (Math.floor(carousel.current.scrollLeft) > carousel.current.scrollWidth - 190 * 3) {
      setHideLast(true);
    }
  }
  ...
  return (
    <div className="relative max-w-[1200px] mx-auto">
      <div className="slider-container max-w-[1200px] mx-auto relative -mr-[15px] -ml-[15px] sm:mx-auto lg:mx-0 xl:hidden">
        <div ref={carousel} className="sliders flex gap-[10px] max-w-[1100px] px-11 mx-auto overflow-x-scroll scroll-smooth pb-10">
          <div className="bg-white rounded-[20px] min-w-[180px] sm:min-w-[250px] pt-[38px] pb-[34px]">
            <Image src={discover1} className="mx-auto w-16" alt="Image" />
            <p className="text-dark text-[17px] mt-[22px] text-center font-bold">Secure</p>
          </div>
          <div className="bg-white rounded-[20px] min-w-[180px] sm:min-w-[250px] pt-[38px] pb-[34px]">
            <Image src={discover2} className="mx-auto w-16" alt="Image" />
            <p className="text-dark text-[17px] mt-[22px] text-center font-bold">Private</p>
          </div>
          <div className="bg-white rounded-[20px] min-w-[180px] sm:min-w-[250px] pt-[38px] pb-[34px]">
            <Image src={discover3} className="mx-auto w-16" alt="Image" />
            <p className="text-dark text-[17px] mt-[22px] text-center font-bold">Browser Based</p>
          </div>
          <div className="bg-white rounded-[20px] min-w-[180px] sm:min-w-[250px] pt-[38px] pb-[34px] relative">
            <Image src={discover4} className="mx-auto w-16" alt="Image" />
            <p className="text-dark text-[17px] mt-[22px] text-center font-bold">Project Mode</p>
        ...
        <div className="left absolute top-1/2 transform -translate-y-1/2 left-2 xl:hidden">
          <svg className={`cursor-pointer mb-10 ${hideFirst ? 'hidden' : 'block'}`} xmlns="http://www.w3.org/2000/svg" width="22" height="33" viewBox="0 0 22 33" fill="none">
          ...
          <svg className={`cursor-pointer mb-10 ${hideFirst ? 'block' : 'hidden'}`} onClick={handleSlidePrev} xmlns="http://www.w3.org/2000/svg" width="22" height="33" viewBox="0 0 22 33" fill="none">
        ...
        <div className="left absolute top-1/2 transform -translate-y-1/2 right-2 xl:hidden">
          <svg className={`cursor-pointer mb-10 ${hideLast ? 'hidden' : 'block'}`} onClick={handleSlideNext} xmlns="http://www.w3.org/2000/svg" width="22" height="33" viewBox="0 0 22 33" fill="none">
          ...
          <svg className={`cursor-pointer mb-10 ${hideLast ? 'block' : 'hidden'}`} xmlns="http://www.w3.org/2000/svg" width="22" height="33" viewBox="0 0 22 33" fill="none">
      ...
      <div className="hidden xl:block right absolute top-1/2 transform -translate-y-1/2 right-0">
