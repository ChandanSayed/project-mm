            ...
            <div className="">
              <div className=" bg-midGray px-4 py-5 rounded-lg mt-[15px] grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="col-span-4 md:col-span-4 flex  ">
                  ...
                  <p className="text-dark flex items-start justify-start text-sm font-jetBrain  font-normal pl-[12px]">
              ...
              <div className=" bg-midGray px-4 py-5 rounded-lg mt-[15px] grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="col-span-4 md:col-span-4 flex flex-col gap-2  ">
                  <p className="text-dark  text-sm font-jetBrain font-normal">Thank you!</p>
              ...
              <div className=" bg-midGray px-4 py-5 rounded-lg mt-[15px] grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="col-span-4 md:col-span-4 flex flex-col gap-2  ">
                  <p className="text-dark  text-sm font-jetBrain font-normal">{`> Please enter the Message Expiration Time (in seconds) between 3 and 300. This can only be set once for all users, by any user, at any time. If this value is is not defined, the default will be 30 seconds.`}</p>
                  <p className="text-sm leading-5 font-normal font-jetBrain">...</p>
                  <p className="text-dark text-sm font-jetBrain font-normal">
              ...
              <div className="bg-errorColor bg-opacity-5 px-4 py-5 rounded-b-xl mt-[15px] border-t-[3px] border-t-blue grid grid-cols-1 lg:grid-cols-5">
                <div className="col-span-1 md:col-span-1 flex items-center">
                  ...
                  <p className="text-blue  text-sm font-jetBrain pl-[10px]">[MessageMoment]</p>
                </div>
                <div className="col-span-4 md:col-span-4 flex justify-between items-center">
                  <p className="text-dark  text-sm font-jetBrain font-normal">Message Expiry Time must be a value between 3 and 300.</p>
                </div>
              </div>
              ...
              <div className=" p-4 rounded-t-lg grid grid-cols-1 lg:grid-cols-5 mt-[15px]">
                <div className="col-span-1 md:col-span-1">
                  <p className="text-sm font-jetBrain text-[#5F27CD]">[joannah]</p>
                </div>
                <div className="col-span-4 md:col-span-4">
                  <p className="text-dark text-sm font-jetBrain leading-5 ">Richard, please check this image. I guess you know what’s about!</p>
                  <p className="text-blue text-sm font-jetBrain mt-[15px] mb-[18px] break-words">https://filemoment.com/sqjgcf9o2s5narz8k</p>
                  <div className="flex justify-between items-center bg-midGray pl-[11px] pr-[20px] rounded-xl">
                    <div className="flex items-center">
                      ...
                      <p className="text-dark font-jetBrain text-sm leading-5 ml-[11px]">img_12839_03.jpg</p>
                    </div>
                    <div className="flex items-center">
                      <p className="text-dark text-sm leading-5 font-normal font-jetBrain pr-5 border-r py-[11px]">7.5 MB</p>
                      <button className="text-blue text-sm font-jetBrain leading-5 font-medium ml-5 ">Download</button>
                    </div>
                  </div>
