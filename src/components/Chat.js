            ...
            <div className="  p-4 h-full overflow-y-auto custom-scrollbar">
              ...
              <div className="">
                ...
                {show ? (
                  ...
                  //           <ReportModalAccordion isOpen={isOpen} handleClose={handleClose} />
                  //         </div>
                  //       </div>
                  //       <div className="flex items-center justify-end px-5 pb-5 lg:p-6 gap-2 border-black border-opacity-10 rounded-b">
                  //         <button className="bg-lightGrey font-jetBrain text-[15px] w-[180px] h-[46px] rounded-md text-dark ease-linear transition-all duration-150 hover-bg-opacity-80" type="button">
                  //           Cancel
                  //         </button>
                  //         <button className={disable ? 'bg-lightGrey font-jetBrain text-[15px] w-[180px] h-[46px] rounded-md text-dark ease-linear transition-all duration-150 hover-bg-opacity-80' : 'bg-blue font-jetBrain text-[15px] w-[180px] h-[46px] rounded-md text-white ease-linear transition-all duration-150 hover-bg-opacity-80'} type="button" onClick={handleReportFile} disabled={disable}>
                  //           Report File
                  //         </button>
                  //       </div>
                  //     </div>
