...
const Chat9 = ({ showMenu, handleChatInput, inputField }) => {
          ...
          <div className={`h-full ${chatScroll ? 'overflow-y-auto' : 'overflow-hidden'} custom-scrollbar flex flex-col justify-between`}>
            <div className={`h-[calc(100%-120px)] ${chatScroll ? 'overflow-y-auto' : 'overflow-hidden lg:pr-1.5'} custom-scrollbar`}>
              ...
              <div className="pb-8 px-3 lg:px-4">
                  ...
                  <div className="col-span-4 md:col-span-4 flex  ">
                    ...
                    <p className="text-dark text-[13px] leading-5 lg:text-sm font-jetBrain  font-normal pl-[12px]">
                      <span className="flex lg:items-center">
                        <span className="w-[14px] mr-3 max-lg:mt-[1.5px]">
                ...
                <SidebarComponents contentLeft="[Laura]" rounded="bg-white border-b !mt-0 !py-4 !rounded-b-none" textLeft="text-[#219653]" contentRight="Nulla facilisi. Cras volutpat, lorem vitae" text=" text-errorColor" />

                <SidebarComponents contentLeft="[Aron]" rounded={'!bg-white !mt-0 !py-4 !rounded-b-none'} contentRight="Nam feugiat suscipit gravida. Phasellus blandit lacus eu leo faucibus, non suscipit massa bibendum. Donec ornare congue egestas. Donec rutrum consequat orci. Cras dignissim odio et fermentum laoreet. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos." textLeft="text-[#704F2C]" />
                ...
                <SidebarComponents contentLeft="" rounded={'!bg-white border-b !mt-0 !py-4 !rounded-b-none'} contentRight="Etiam bibendum velit ex, sollicitudin porttitor massa pretium quis" textLeft="text-[#EDC447]" />
                ...
                <div className="bg-blue bg-opacity-5 px-4 py-5 rounded-b-xl mt-[15px] border-t-[3px] border-t-blue grid grid-cols-1 lg:grid-cols-5">
                  ...
                  <div className="col-span-4 md:col-span-4 flex justify-between items-center">
                    <p className="text-dark  text-[13px] leading-5 lg:text-sm font-jetBrain font-semibold">The Message Expiration Time has already been set for this chat session.</p>
                  </div>
                </div>
