  ...
  return (
    <div className={`buttons pl-[6px] flex gap-[6px] lg:gap-[5px] ${classes}`}>
      <div className="relative">
        ...
        {openChat ? (
          <button onMouseEnter={handleGenerateTip} onMouseLeave={handleGenerateTipLeave} onClick={secure ? generateLinkSecure : generateLink} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white rounded-[5px] hover:bg-dark md:hover:bg-opacity-50">
