        ...
        <div className="flex justify-between items-center bg-white">
          ...
          <div className="flex mt-[18px] items-center">
            ...
            <div className={`relative mr-[15px] group ${transferError ? 'hidden' : ''}`}>
              ...
              <svg onClick={() => setTransferError(true)} className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer hidden group-hover:lg:block" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
