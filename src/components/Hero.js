...
const Hero = () => {
  return (
    <div className="bg-gradient-to-b from-blue-10 from-0% via-blue-0 via-90% lg:to-white to-90% border-t border-black border-opacity-5 pt-[30px] px-[15px] lg:mb-[50px]">
