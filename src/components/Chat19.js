...
const Chat19 = ({ showMenu, handleLeave }) => {
          ...
          <div className={`h-full ${chatScroll ? 'overflow-y-auto' : 'overflow-hidden'} custom-scrollbar flex flex-col justify-between`}>
            <div className={`h-[calc(100%-120px)] ${chatScroll ? 'overflow-y-auto' : 'overflow-hidden lg:pr-1.5'} custom-scrollbar`}>
              ...
              <div className="pb-8 px-3 lg:px-4">
                ...
                <div className={`bg-errorColor bg-opacity-5 px-4 py-5 rounded-b-xl mt-[15px] border-t-[3px] border-t-[#EB5757] grid grid-cols-1 lg:grid-cols-5`}>
                  <div className="col-span-1 md:col-span-1 flex items-center max-lg:mb-[5px]">
                    ...
                    <p className={`text-blue text-[13px] leading-normal mt-[.25px] lg:text-sm font-jetBrain font-semibold`}>[MessageMoment.com]</p>
                  </div>
                  <div className="col-span-4 md:col-span-4 flex justify-between items-center">
                    <p className={`text-dark  text-[13px] leading-5 lg:text-sm font-jetBrain font-semibold`}>The chat session is full! There are currently 10/10 users joined.</p>
                  </div>
                </div>
                ...
                <div className="bg-blue bg-opacity-5 px-4 py-5 rounded-b-xl mt-[15px] border-t-[3px] border-t-blue grid grid-cols-1 lg:grid-cols-5">
                  <div className="col-span-1 md:col-span-1 flex items-center max-lg:mb-[5px]">
                    ...
                    <p className="text-blue text-[13px] leading-normal mt-[.25px] lg:text-sm font-jetBrain pl-[10px]">[MessageMoment]</p>
                  </div>
                  <div className="col-span-4 md:col-span-4 flex justify-between items-center">
