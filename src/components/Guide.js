  ...
  return (
    <div className="bg-blue px-[15px] pt-[40px] pb-[60px] lg:pt-[70px] lg:pb-[75px]">
      <div className="max-w-[1320px] mx-auto">
        <h2 className="font-bold text-[34px] text-center lg:text-[60px] tracking-[-.5px] px-[30px] lg:tracking-normal sm:max-w-[450px] lg:max-w-[934px] mx-auto text-white">Express yourself freely, anytime, with those you know.</h2>
        <div className="relative w-max mx-auto pt-[14px] mb-14">
          <Image src={img} alt="Image" className="mx-auto relative z-10 max-lg:w-full" />
