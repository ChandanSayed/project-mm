...
const FooterBottom = ({ classes = '', textColor = 'text-darkGrey' }) => {
  ...
  return (
    <div className={`flex flex-col lg:flex-row items-center justify-between w-full max-w-[1440px] mx-auto px-4 ${classes}`}>
      ...
      <p className={`${textColor} font-medium text-[10px] lg:text-[13px] w-[318px] text-right flex justify-center order-1 lg:order-none lg:justify-end items-center gap-[5px] lg:gap-[10px]`}>
