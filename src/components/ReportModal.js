                ...
                <div className="">
                  <div className="max-w-[720px] mx-auto">
                    <div className="justify-center items-end lg:items-center overflow-x-hidden overflow-y-auto lg:inset-0 z-50 outline-none focus:outline-none bottom-0 ">
                      ...
                      <div className="border w-full border-black border-opacity-10 rounded-lg shadow-lg relative flex flex-col h-[calc(100vh-220px)] mt-12 lg:pt-0 lg:max-h-[570px] xl:max-h-[650px] max-w-[670px] bg-white outline-none focus:outline-none mb-[10px] lg:mb-0">
                        <div className="px-5 border-b border-solid border-black border-opacity-10 rounded-t gap-5 relative">
                          <Image src={report} alt="Cookies" className="w-[60px] lg:w-[80px] absolute max-lg:left-1/2 max-lg:transform max-lg:-translate-x-1/2 -top-4 lg:-top-6 " />
                          <h3 className="text-[17px] lg:text-[26px] max-lg:pt-16 text-blue font-bold py-4 lg:py-5 text-center">Report a FileMoment.com File</h3>
                        ...
                        {!showPopUp ? (
                          ...
                          <div className="relative p-5 flex-auto px-[18px] overflow-y-auto max-h-[calc(100vh-300px)] custom-scrollbar">
                            <div className="flex items-center justify-center flex-col gap-5">
                              ...
                              <p className="text-[15px] pb-[10px] max-lg:text-[13px] font-jetBrain mx-[80px] text-dark font-normal leading-[24px] text-center">Our team will review the reported file promptly and take appropriate actions if necessary.</p>
                            </div>
                          </div>
                        )}
                        ...
                        {showPopUp ? (
                          <div className="flex items-center justify-center gap-[10px] py-3 mr-5 border-t">
                            <button className="bg-blue  font-jetBrain text-[15px] w-full lg:w-[180px] h-[46px] rounded-md text-white ease-linear transition-all duration-150 hover:bg-opacity-80" type="button" onClick={handleClose}>
                              Continue
                            </button>
                          </div>
                        ) : (
