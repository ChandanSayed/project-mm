...
const Steps = () => {
  const steps = [
    { id: 1, img: one, step: 'Step 1', stepName: 'Get Started' },
    { id: 2, img: two, step: 'Step 2', stepName: 'Share Link' },
  ...
  return (
    <div className="steps-desktop flex gap-5">
      {steps.map((step, i) => {
        return (
          <div className={`step bg-white rounded-[20px] relative p-[30px] cursor-pointer ${index === i ? 'sm:w-[220px] lg:flex-1' : 'sm:w-[220px] lg:w-[260px] bg-opacity-20 text-center'}`} kay={step.id} onMouseEnter={() => setIndex(i)}>
            ...
            <Image src={step.img} alt="step" className="w-[60px] h-[60px] lg:w-[80px] lg:h-[80px] mt-[30px] sm:ml-[45px] lg:ml-[90px] mb-5" />
