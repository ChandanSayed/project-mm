...
const Steps = () => {
  ...
  function handleSlideNext() {
    ...
    console.log(carousel.current.scrollLeft, carousel.current.scrollWidth - 190 * 3);
    setIndex(prev => {
  ...
  return (
    <div className="relative">
      <div ref={carousel} className="steps-desktop sliders flex gap-[10px] sm:gap-5 overflow-x-scroll scroll-smooth px-11 sm:px-0 sm:overflow-x-hidden -mx-[15px] sm:mx-auto pb-10">
        {steps.map((step, i) => {
          return (
            <div className={`step bg-white rounded-[20px] min-w-[180px] sm:min-w-0 relative p-5 sm:p-[30px] cursor-pointer ${index === i ? 'sm:w-[220px] lg:w-[260px] xl:flex-1' : 'sm:w-[220px] lg:w-[260px] bg-opacity-20 text-center'}`} key={step.id} onMouseEnter={() => setIndex(i)}>
              ...
              <Image src={step.img} alt="step" className={`w-[60px] h-[60px] lg:w-[80px] lg:h-[80px] mt-[20px] ${index === i ? 'mx-auto sm:ml-[45px] lg:ml-[60px]' : 'mx-auto'} mb-[17px] sm:mb-5`} />
