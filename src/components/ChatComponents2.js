const SidebarComponents2 = ({ bg, textLeft, textRight, contentLeft, contentRight }) => {
  return (
    <div className={`bg-errorColor ${bg} bg-opacity-5 px-4 py-5 rounded-b-xl mt-[15px] border-t-[3px] border-t-[#EB5757] grid grid-cols-1 lg:grid-cols-5`}>
      <div className="col-span-1 md:col-span-1 flex lg:items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="max-lg:mt-[2px]" width="14" height="14" viewBox="0 0 14 14" fill="none">
        ...
        <p className={`text-blue ${textLeft} text-[13px] leading-5 lg:text-sm font-jetBrain pl-[10px] font-semibold max-lg:mb-[5px]`}>{contentLeft}</p>
      </div>
