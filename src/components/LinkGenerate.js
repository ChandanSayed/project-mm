...
const LinkGenerate = () => {
  ...
  return (
    <>
      <div className="bg-blue max-lg:hidden max-w-[1096px] rounded-[20px] absolute z-50 -bottom-[110px] left-1/2 transform -translate-x-1/2 w-full mx-auto">
        ...
        <div className="link bg-black bg-opacity-20 rounded-[0_0_20px_20px] pt-[18px] px-[15px]  lg:px-[30px] lg:pt-[35px] lg:pb-[25px] pb-5">
          <div className="flex">
            ...
            <div className="buttons pl-[6px] flex gap-[5px]">
              ...
              <div className="relative">
                <div className={`qr-code bg-black bg-cover bg-no-repeat p-[10px] rounded-[10px] w-[280px] overflow-hidden absolute left-1/2 transform -translate-x-1/2 bottom-[58px] ${!showQr && 'hidden'}`}>
