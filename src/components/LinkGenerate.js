...
const LinkGenerate = () => {
  ...
  console.log(HandleSelect.current);
          ...
          <div className="flex">
              ...
              {secure ? (
                <>
                  <div className="flex items-center flex-1 pr-[15px]">
                    ...
                    <div className="cursor-pointer flex-1 flex items-center justify-between handle-select" ref={HandleSelect} onClick={handleSelect}>
                ...
                <>
                  <div className="flex items-center flex-1 pr-[15px]">
                    ...
                    <div className="cursor-pointer flex items-center justify-between handle-select" ref={HandleSelect} onClick={handleSelect}>
            ...
            <div className="buttons pl-[6px] flex gap-[5px]">
              <div className="relative">
                ...
                {openChat ? (
                  <button onMouseEnter={handleGenerateTip} onMouseLeave={handleGenerateTipLeave} onClick={secure ? generateLinkSecure : generateLink} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] hover:bg-dark hover:bg-opacity-10">
              ...
              <div className="relative">
                ...
                {openChat ? (
                  <button onMouseEnter={handleCopy} onMouseLeave={handleCopyLeave} onClick={secure ? copyTOClipSecure : copyTOClip} className="cursor-pointer h-[50px] w-[50px] flex items-center justify-center border-[1.5px] border-white border-opacity-20 rounded-[5px] bg-white hover:bg-opacity-90">
