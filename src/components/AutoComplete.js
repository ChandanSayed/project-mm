  ...
  return (
    <div className="autocomplete-input">
      <div className="relative">
        ...
        <input value={inputValue} ref={inputField} onChange={handleInputChange} onBlur={handleOnBlur} type="text" name="text" id="text" className={`block w-full h-[50px] rounded-md border-none py-1.5 pl-10 pr-20 ${textColor} text-sm font-jetBrain`} placeholder="" />
        {showActiveIcon ? (
