...
const AutoComplete = ({ value = '', activeIcon = false, textColor = 'text-dark', handleChatInput = () => console.log(), inputField }) => {
  ...
  return (
    <div className="autocomplete-input px-4">
      <div className="relative">
        ...
        <input value={inputValue} ref={inputField} type="text" name="text" id="text" className={`block w-full h-[50px] rounded-md border-0 py-1.5 pl-10 pr-20 ${textColor} outline-none  sm:text-sm sm:leading-6 font-jetBrain text-[13px] leading-6 lg:text-sm`} placeholder="" />
        {showActiveIcon ? (
