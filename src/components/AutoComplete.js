  ...
  return (
    <div className="mt-2 rounded-b-md border-t border-black border-opacity-10 shadow-sm bg-[#f5f5f5] px-2.5 lg:px-4 py-5">
      <div className="autocomplete-input">
        ...
        <div className={`bg-white rounded-lg mt-2.5 border border-[#eee] p-[11px] justify-between ${showUploadFile ? 'flex' : 'hidden'}`}>
          <div>
            ...
            <span className="ml-2.5 text-sm font-jetBrain">img_12839_03.jpg</span>
          </div>
          <div>
            <span className="text-xs text-dark opacity-40 font-medium font-jetBrain">7.5mb</span>
