      ...
      <div className="border-t bg-gradient-to-b from-blue-10 from-0% via-blue-0 via-60% to-white to-90% px-[15px]">
        ...
        <div className="relative max-w-[1320px] mx-auto">
          ...
          <div className="flex flex-col justify-center items-center pb-[50px] lg:pb-[70px] relative z-10 -mt-[90px] lg:-mt-[113px] ">
            ...
            <button onClick={() => router.push(`/#linkGenerate`)} className={`flex justify-center text-sm lg:text-[15px] items-center rounded-md h-[46px] w-[300px] px-5 bg-blue hover:bg-opacity-80 text-white font-jetBrain font-bold`}>
              Try MessageMoment
            </button>
          </div>
        </div>
