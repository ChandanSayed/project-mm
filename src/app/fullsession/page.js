        ...
        <div className='bg-gradient-to-b from-blue-10 from-0% via-blue-0 via-60% to-white to-90% px-[15px] '>
            <div className='flex justify-center flex-col items-center h-[100vh]'>
                ...
                <div
                    ...
                    <Image
                        src={session}
                        className='w-[128px] h-[128px] relative bottom-20 max-lg:bottom-22 max-md:bottom-24 max-sm:bottom-20 max-md:tracking-tighter max-md:w-[100px] max-md:h-[100px] '/>
                    <div className='flex justify-center lg:gap-8 md:gap-6 flex-col items-center relative bottom-10'>
                        <h1 className='text-blue text-[26px] font-bold leading-normal text-center max-md:text-[17px] mt-[20px] max-md:mt-[20px] max-md:px-7 '>
                        The chat session is full! There are <br/> currently 10/10 users joined
                        </h1>
