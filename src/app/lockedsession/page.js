              ...
              <div className="mt-[35px] lg:mt-[25px] border-t border-black border-opacity-10 pt-[126px] pb-[84px] lg:pt-[121px] lg:pb-[100px] ">
                <div className="flex justify-center flex-col items-center">
                  ...
                  <div className=" relative bg-white border border-black border-opacity-10 flex justify-center flex-col items-center max-w-[720px] z-20 rounded-[10px] min-w-full">
                    <Image src={locked} className="w-[128px] relative bottom-16 max-lg:bottom-14 max-sm:bottom-12 max-lg:tracking-tighter max-lg:w-[100px]  " />
                    <div className="flex justify-center lg:gap-8 md:gap-6 flex-col items-center relative bottom-10 mb-[60px] max-lg:mb-[40px]">
                      <h1 className="text-blue text-[26px] font-bold leading-normal text-center max-lg:text-[17px] mt-[20px] max-lg:mt-[20px] max-lg:mx-[51px] mx-[125px]">The chat session is locked</h1>
                      <p className="text-[15px] text-dark font-jetBrain max-md:text-[13px] max-md:text-center max-md:px-6 max-md:mb-[32px] max-md:mt-[20px] ">Unfortunately you are unable to enter the chat at this time.</p>
                      <ReturnToHomepage />
                    </div>
                  </div>
                </div>
